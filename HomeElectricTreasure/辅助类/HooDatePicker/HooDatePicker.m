...
#define kHooDatePickerHighlightColor [UIColor colorWithRed:46.0/255.0 green:164.0/255.0 blue:252.0/255.0 alpha:1.0]
...
- (instancetype)initWithSuperView:(UIView*)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(0.0, SCREEN_HEIGHT, SCREEN_WIDTH, kHooDatePickerHeight)]) {
