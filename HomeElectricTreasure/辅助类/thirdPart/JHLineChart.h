...
@protocol JHLineChartDelegate <NSObject>
 ...
 * 显示环比
 */
@property (nonatomic , assign)BOOL showMomLabel;

@property (nonatomic,strong)UIView *lineView;//竖线
@property (nonatomic,strong)UILabel *anLabel;//同比
@property (nonatomic,strong)UILabel *momLabel;//环比
...
@property (nonatomic,assign)id<JHLineChartDelegate>delegate;
