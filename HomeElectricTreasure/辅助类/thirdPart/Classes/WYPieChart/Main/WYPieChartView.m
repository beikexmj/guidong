...
#define DEFAULT_PIE_CHART_MARGIN 10
...
- (void)initiliazeComponent {
    ...
    _yearLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 50, 20)];
//    _yearLabel.text = @"2017";
    _yearLabel.font = [UIFont systemFontOfSize:11];
    _yearLabel.textAlignment = NSTextAlignmentCenter;
    _yearLabel.textColor = [UIColor colorWithRed:96/255.0 green:96/255.0 blue:96/255.0 alpha:1];
    _yearLabel.center = CGPointMake(self.wy_boundsCenter.x, self.wy_boundsCenter.y-8);
    [self addSubview:_yearLabel];
    
    _quarterLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 50, 20)];
//    _quarterLabel.text = @"二季度";
    _quarterLabel.font = [UIFont systemFontOfSize:13];
    _quarterLabel.textAlignment = NSTextAlignmentCenter;
    _quarterLabel.textColor = [UIColor colorWithRed:96/255.0 green:96/255.0 blue:96/255.0 alpha:1];
    _quarterLabel.center = CGPointMake(self.wy_boundsCenter.x, self.wy_boundsCenter.y+8);
    [self addSubview:_quarterLabel];
