...
#define COLOR_0TH [UIColor whiteColor]
...
- (instancetype)init {
    ...
    if (self) {
        _parameters = [NSMutableDictionary dictionaryWithObjectsAndKeys:@2.0, kLineChartAnimationDuration,
                       ...
                       @(true), kLineChartScrollable,
                       @(true), kLineChartPinchable,
                       @(kWYLineChartMainStraightLine), kLineChartLineStyle,
                       @(true), kLineChartDrawGradient,
                       @(kWYLineChartJunctionShapeHollowCircle), kLineChartJunctionStyle,
                       COLOR_0TH, kLineChartBackgroundColor,
                       nil];
    }
    return self;
}
