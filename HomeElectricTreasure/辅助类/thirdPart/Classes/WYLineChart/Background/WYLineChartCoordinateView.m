...
//        [self addSubview:label];
    ...
    if (self.parentView.yAxisHeaderSuffix) {
        ...
        label = [[UILabel alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.frame) - self.parentView.calculator.xAxisLabelHeight+10, labelWidth, self.parentView.calculator.xAxisLabelHeight)];
        label.font = self.parentView.labelsFont;
        label.textColor = self.parentView.labelsColor;
        label.backgroundColor = [UIColor clearColor];
