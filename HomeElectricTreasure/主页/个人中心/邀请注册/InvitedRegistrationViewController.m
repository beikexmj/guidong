...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [myCell.headerIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@%@",BASE_URL,@"res/avatar?userId=",_myArr[indexPath.row].inviteeId]] placeholderImage:[UIImage imageNamed:@"默认头像"]];
    ...
    myCell.time.text =  [StorageUserInfromation timeWithTimeIntervalString:_myArr[indexPath.row].invitationDate];
