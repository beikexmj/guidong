...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   StorageUserInfromation * storage =[StorageUserInfromation storageUserInformation];
    if (indexPath.row == 0) {
        ...
        cell.regimentationLabel.text = @"我的邀请二维码";
...
- (void)sexBtnClick:(UIButton *)btn{
    ...
    switch (btn.tag) {
        case 10:
        {
            sexChoseCell.menImg.image = [UIImage imageNamed:@"per_massage_circle2"];
        ...
        case 20:
        {
            sexChoseCell.womenImg.image = [UIImage imageNamed:@"per_massage_circle2"];
...
- (void)resetImg:(UIImage*)image{
    ...
    [ZTHttpTool postWithImageUrl:@"upload/avatar" param:dict postImageArr:@[@[image],@[@"file"]] mimeType:@"image/png" success:^(id responseObj) {
