...
@interface ElectricityBuyRecordTwoViewController ()
@property (nonatomic,strong)NSMutableArray *myArray;
@end

@implementation ElectricityBuyRecordTwoViewController
...
-(void)fetchData{
    ...
    [ZTHttpTool postWithUrl:@"postPayLog/queryPostPayLog" param:dict success:^(id responseObj) {
...
//                [MBProgressHUD showError:@"没有数据"];
                [self.myTableView addEmptyViewWithImageName:@"购电记录-缴费记录" title:@"暂无缴费记录"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.money.text = [NSString stringWithFormat:@"缴费 %@ 元",list.money];
    cell.time.text = list.time;
    cell.ElecCardNo.text = [NSString stringWithFormat:@"缴费账户编号:%@",list.accountNo];
